/* Lab 3 Part IV
 *    Assume initial behavior: as soon as program is started, the clock starts.
...
_start:
            ...
            LDR     R7, =2000000        // 0.01 seconds
            STR     R7, [R8]
            MOV     R7, #0b011          // Starts timer
            STR     R7, [R8, #0x8]

MAIN:	    MOV		R0, #0              // For hundreths of seconds
            MOV     R10, #0             // For seconds
...
DISPLAY:    
            ...
            STR     R4, [R5, #0x20]     // Display the numbers on HEX3-0
...
DELAY:	    LDR     R7, [R8, #0xc]      // Checks value from timer
            ...
            // After delay
            CMP     R0, #99              // If R0 != 99, R0++ only
            ADDNE   R0, #1
            BNE     DISPLAY
            
            CMP     R10, #59            // If R0 == 99 and R10 != 59, R10++, R0 = 0
            ADDNE   R10, #1
            MOVNE   R0, #0
            BNE     DISPLAY

            B       MAIN                // If R0 == 99 && R10 == 59, R10 = R0 = 0
